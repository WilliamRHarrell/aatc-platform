...
import type { ApplyFormContent } from '@/app/apply/apply-form-content'
...
// ── Main page ─────────────────────────────────────────────────
export default function ArtistApplyForm({ content }: { content: ApplyFormContent }) {
            ...
            {step === 3 && (
              <div>
                ...
                <div className="space-y-6">
                  ...
                  {booth.is_veteran && (
                    <FileUploadField
                      label={content.veteranDocLabel}
                      hint={content.veteranDocHelp}
                      required
