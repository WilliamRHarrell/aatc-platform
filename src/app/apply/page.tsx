    ...
    <div className="min-h-screen">
      ...
      <section className="px-4 py-12 text-center">
        <p className="mb-0 text-sm font-medium uppercase tracking-widest" style={{ color: '#8B7355' }}>
          <span className="text-emboss">Pre-Registration</span>
        </p>
        <h2 className="font-display text-3xl font-bold text-white sm:text-4xl md:text-5xl leading-relaxed">
          <span className="text-emboss">Pre-Register for AATC</span>
          <br className="hidden sm:block" />
          <span className="text-emboss" style={{ color: '#C4A882' }}> Fayetteville 2027</span>
        </h2>
        ...
        <div className="mt-6 flex flex-col items-center gap-2 sm:flex-row sm:justify-center sm:gap-6">
          ...
          <span className="text-emboss inline-flex items-center gap-2 whitespace-nowrap text-sm" style={{ color: '#999999' }}>
            ...
            <a href="https://share.google/vRhsv0xqNzDRTPtGC" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 transition-colors hover:text-white">Crown Complex</a>
          </span>
          <span className="hidden h-4 w-px sm:block" style={{ backgroundColor: '#2a2a2a' }} />
          <span className="text-emboss text-sm" style={{ color: '#999999' }}>Fayetteville, NC</span>
        </div>
      </section>
      ...
      <section className="px-4 pb-16">
        <div
          ...
          style={{ backgroundColor: '#1a1a1a', border: '1px solid #2a2a2a' }}
        >
          <h3 className="font-display mb-6 text-xl font-bold text-white">What to Expect When Applying</h3>
      ...
      >
        ...
        <p className="font-display text-lg font-bold text-white"><span className="text-emboss">ALL AMERICAN TATTOO CONVENTION</span></p>
