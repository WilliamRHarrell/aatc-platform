    ...
    <div className="min-h-screen">
      ...
      <div className="border-b px-4 pb-8 pt-10 text-center" style={{ borderColor: '#2a2a2a' }}>
        <h1 className="font-display text-4xl font-bold text-white sm:text-5xl">
          <span className="text-emboss">Tattoo Collectors Award</span>
        </h1>
        <p className="mt-2 text-sm" style={{ color: '#999' }}>
          <span className="text-emboss">People&apos;s Choice · Vote for your favorite in each category</span>
        </p>
        {contests.length > 0 && (
      ...
      <div className="mx-auto max-w-5xl px-4 py-10">
        ...
        {contests.length === 0 ? (
          ...
          >
            <p className="text-sm font-medium text-white">Voting opens soon</p>
            <p className="mt-1 text-sm" style={{ color: '#555' }}>
              Check back after the convention to cast your votes.
            </p>
          </div>
        ) : (
          <div className="space-y-14">
                  ...
                  <div className="mb-5">
                    ...
                    {!hasVoted && (
                      <p className="mt-1 text-xs" style={{ color: '#555' }}>
                        <span className="text-emboss">Tap a photo to enlarge · Select your favorite to vote</span>
                      </p>
                    )}
                  </div>
            ...
            {votedCount === contests.length && contests.length > 0 && (
              ...
              >
                <p className="font-display text-xl font-bold text-white">Thank you for voting!</p>
                <p className="mt-1 text-sm" style={{ color: '#999' }}>
                  Your votes have been recorded. Winners will be announced at AATC 2027.
                </p>
              </div>
            )}
          </div>
